...
const initialiseMenuScene = () => {
    ...
    showMessage('Use OK to attack!', halfWidth, halfHeight, 30, 100000, 960);
    showMessage('Press OK to play. ', halfWidth, halfHeight + 50, 30, 100000, 1000);
    showMessage("", halfWidth, halfHeight + 180, 20)
    showMessage('', halfWidth, halfHeight + 200, 20);
}
